    ...
    <div class="row">
        <div class="col-sm-12">
            <div> 
                ...
                <form action="/admin/article/editor{{(!empty($data->article_id)? "/" . $data->article_id: "")}}" method="POST">
                            ...
                            <div class="tab-pane active" id="1b">
                                <div class="col-sm-12 " style="background: aliceblue;">
                                    ...
                                    <div class="col-sm-2 form-group">
                                        ...
                                        <input id="article_id" name="article_id" type="text" value="{{(!empty($data->article_id)? $data->article_id: "")}}" >
