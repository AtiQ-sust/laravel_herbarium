...
<table class="table" id="table">
    ...
    <tbody>
        ...
        <tr id="_{{$item->kingdom_id}}" class="del-class-{{$item->kingdom_id}}">
            <td>{{$item->kingdom_id}}</td>
            <td>{{$item->code}}</td>
            <td>{{$item->title}}</td>
            <td>{{$item->description}}</td>
            <td>{{$item->upsert_date}}</td>
            <td data-type="button">
							<button type="button" class="edit-modal btn btn-info"   
								data-info="{{$item->kingdom_id}},{{$item->code}},{{$item->title}},{{$item->description}}">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.errors){
                  ...
                  //{{$item->kingdom_id}},{{$item->code}},{{$item->title}},{{$item->description}}
